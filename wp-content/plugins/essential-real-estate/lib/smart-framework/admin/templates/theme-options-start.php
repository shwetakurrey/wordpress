...
<div class="gsf-theme-options-wrapper wrap" style="display: block">
	<form action="<?php echo esc_url(admin_url( 'admin-ajax.php' ) . '?action=gsf_save_options'); ?>" method="post" enctype="multipart/form-data" class="gsf-theme-options-form">
		<input type="hidden" id="_wpnonce" name="_wpnonce" value="<?php echo esc_attr(GSF()->helper()->getNonceValue()) ?>" />
